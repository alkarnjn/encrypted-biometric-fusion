...
if __name__ == "__main__":
    diagonal_encoding_arbitrary("data/exact_results/exact_best_P_value_transpose_lambda=0.01_margin=0.1_gamma=32_reg=0.txt","data/exact_results/exact_best_P_value_transpose_lambda=0.01_margin=0.1_gamma=32_reg=0.txt")
    diagonal_encoding_arbitrary("data/degree=2strict/approximate_best_P_value_transpose_lambda=0.1_margin=0.1_gamma=32_reg=0.txt","data/degree=2strict/approximate_best_P_value_transpose_lambda=0.1_margin=0.1_gamma=32_reg=0.txt")
